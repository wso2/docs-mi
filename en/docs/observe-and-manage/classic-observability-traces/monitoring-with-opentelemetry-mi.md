...
With the above configuration, OTLP uses the gRPC transport by default for exchanging data. This behaviour can be changed by setting the value of the configuration `protocol` to `http`.
