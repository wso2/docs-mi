...
See [Configuring Logs]({{base_path}}/observe-and-manage/micro-integrator/classic-observability-logs/configuring-log4j2-properties/#wire-logs-and-header-logs) for instructions.
