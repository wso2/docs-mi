...
1. If you have already created an [Integration Project]({{base_path}}/develop/create-integration-project), right-click the [ESB Config module]({{base_path}}/develop/create-integration-project/#types-of-projects) and go to **New → Inbound Endpoint** to open the **New Inbound Endpoint Artifact**.
