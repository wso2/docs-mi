...
- **Basic Authentication Handler:** This handler provides a traditional approach by validating user credentials (username and password) against the internal user store configured in the server. Learn more: [Securing an API with basic auth]({{base_path}}/learn/examples/rest-api-examples/securing-rest-apis-with-basic-authentication).
