...
The integration artifacts you develop using MI for VS Code extension are built into a Docker image from the Kubernetes Exporter module. Therefore, you must update the `integration_cr.yml` file (in your Kubernetes Exporter module) with the secrets you generated by using the following syntax:
