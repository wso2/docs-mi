...
Following methods allow you to import connectors into the project.

#### Method 1: Import connectors from the VS Code Extension
...
#### Method 2: Import downloaded connectors

1. Navigate to the **Project Overview** page.
2. Click on **Add artifact**.
3. Click **+ View More** under **Create an Integration**.
4. Select **Connections** under **Other Artifacts** to open the **Connector Store** form.
5. There you can click on the **Import Connector** button to import a connector zip file. 
...
2. Click the **+** icon. 
3. In the mediator's palette, scroll down to the chosen connector. 
