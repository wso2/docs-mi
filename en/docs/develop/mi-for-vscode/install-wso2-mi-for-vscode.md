...
- Download and install the Visual Studio Code editor from [here](https://code.visualstudio.com/download).
    ...
    !!! info
        For more information on installing the Visual Studio Code, refer to [Visual Studio Code documentation](https://code.visualstudio.com/docs/setup/setup-overview).
...
!!!info "What's Next?"
    - See [Quick Start Guide]({{base_path}}/develop/mi-for-vscode/wso2-mi-for-vscode-qsg) to get started with MI VSCode extension.
