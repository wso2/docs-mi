...
!!! warning
    WSO2 Integration Studio is deprecated. It is recommended to use the [Micro Integrator extension]({{base_path}}/develop/mi-for-vscode/mi-for-vscode-overview/) for VS Code instead.
