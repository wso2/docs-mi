...
Once you [deploy and run]({{base_path}}/develop/using-embedded-micro-integrator) your integration solution, you may encounter errors and identify the required modifications for your artifacts. Use the mediation debugging feature in WSO2 Integration Studio to troubleshoot errors.
...
Now you can send a request to the external Micro Integrator and debug the flow as discussed under [Instant debugging using Micro Integrator](#instant-debugging-using-micro-integrator).
