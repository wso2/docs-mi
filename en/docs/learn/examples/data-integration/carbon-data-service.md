...
3. [Create a Datasource project]({{base_path}}/develop/create-datasources) and then [create a datasource]({{base_path}}/develop/creating-artifacts/data-services/creating-datasources).
