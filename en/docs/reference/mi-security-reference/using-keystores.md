...
* [Configure keystores for the Micro Integrator]({{base_path}}/install-and-setup/setup/mi-setup/security/configuring-keystores)
* [Create new keystores]({{base_path}}/install-and-setup/setup/mi-setup/security/creating-keystores)
