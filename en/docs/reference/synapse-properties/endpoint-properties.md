...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            You can use <strong>synapse.endpoint.http.oauth.enable.global.timeout.configs</strong> to enable or disable the use of global timeout configurations.<br><br>
            This parameter is available in MI 4.4.0.45 onwards.<br><br>
            <strong>Note:</strong> When enabled, these global configurations will apply if the following conditions are met:<br>
                1. useGlobalConnectionTimeoutConfigs parameter is set to true or not configurred.<br>
                2. timconfig parameters (connectionTimeout, connectionRequestTimeout, socketTimeout) are not configured at the endpoint level. (local values gets precedence over global values).
      ...
      <tr>
         ...
         <td>
            ...
            <div class="admonition note">
                ...
                <p>Requires Micro Integrator version 4.4.0.34 (U2) or later to use this global parameter.</p>
            </div>
         </td>
      </tr>
      <tr>
