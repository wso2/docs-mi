   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            ...
            Default: 30000.</br></br>
            <b>Note</b>: This value can be globally configured using the <code>synapse.global_endpoint_suspend_duration</code> property under <code>[synapse_properties]</code> in the <code>MI_Home/conf/deployment.toml</code> file. This configuration will apply to all endpoints unless overridden at the endpoint level.
         </td>
      </tr>
      <tr>
         <td>
      ...
      <tr>
         ...
         <td>
            ...
            Default: 1.</br></br>
            <b>Note</b>: This value can be globally configured using the <code>synapse.global_endpoint_suspend_progression_factor</code> property under <code>[synapse_properties]</code> in the <code>MI_Home/conf/deployment.toml</code> file. This configuration will apply to all endpoints unless overridden at the endpoint level.
         </td>
      </tr>
    </tbody>
</table>
