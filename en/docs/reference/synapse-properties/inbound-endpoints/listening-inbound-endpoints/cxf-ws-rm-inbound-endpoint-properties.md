...
The following properties can be configured when [creating a CXF WS-RM inbound endpoint]({{base_path}}/develop/creating-artifacts/creating-an-inbound-endpoint).
