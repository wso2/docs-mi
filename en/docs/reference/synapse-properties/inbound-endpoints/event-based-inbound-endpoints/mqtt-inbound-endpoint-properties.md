...
Listed below are the properties used for [creating an MQTT inbound endpoint]({{base_path}}/develop/creating-artifacts/creating-an-inbound-endpoint).

### Required Properties

The following properties are required when [creating a MQTT inbound endpoint]({{base_path}}/develop/creating-artifacts/creating-an-inbound-endpoint).
...
The following optional properties can be configured when [creating an MQTT inbound endpoint]({{base_path}}/develop/creating-artifacts/creating-an-inbound-endpoint).
