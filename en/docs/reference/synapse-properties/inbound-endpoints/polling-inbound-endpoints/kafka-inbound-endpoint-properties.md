...
The following optional properties can be configured when [creating a Kafka inbound endpoint]({{base_path}}/develop/creating-artifacts/creating-an-inbound-endpoint).
