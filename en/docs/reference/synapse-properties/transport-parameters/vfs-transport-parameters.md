   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            ...
            <br>Available in <b>MI 4.4.0.59</b> and later for SFTP connections.
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            The maximum number of unanswered SSH keep-alive messages before the SFTP session is terminated. Possible value: <code>3</code>. The default value is <code>1</code>. <br>Available in <b>MI 4.4.0.59</b> and later for SFTP connections.
         </td>
      </tr>
      <tr>
         <td>
