...
<table>
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            The cron expression for the transport receiver to poll the file URI location. The value is expressed in cron expression. For example, "0 0/2 * * * ?" to specify 2 minutes. Specify a positive integer.
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
           Whether to move, or delete on the files after the transport has processed them. Possible values are <code>MOVE</code>, <code>DELETE</code>. The default value is <code>DELETE</code>.
         </td>
      </tr>
      <tr>
         <td>
         ...
         <td>
            Whether to move, or delete on the files if a failure occurs. Possible values are <code>MOVE</code>, <code>DELETE</code>. The default value is <code>DELETE</code>.
         </td>
      </tr>
      <tr>
         <td>
