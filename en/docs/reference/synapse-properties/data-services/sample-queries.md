...
!!! Info
    For detailed instructions on defining a data service using WSO2 Integrator: MI VS Code Extension, see [Creating a Data Service]({{base_path}}/develop/creating-artifacts/data-services/creating-data-services).
