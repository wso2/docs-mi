...
!!! Info
    For detailed instructions on defining a data service using MI for VS Code extension, see [Creating a Data Service]({{base_path}}/develop/creating-artifacts/data-services/creating-data-services).
