...
!!! Note
      - From <strong>MI 4.4.0.x</strong> onwards, the task scheduler supports graceful shutdown. When the shutdown hook is triggered, the scheduler waits for currently running tasks to complete, up to a maximum of 180 seconds.
    ...
    <span id="cb2-24"><a href="#cb2-24"></a>   &lt;/task&gt;</span></code></pre>
      ...
      <tr class="even">
         ...
         <td>
            ...
            <strong>Note:</strong> This property is available from MI 4.4.0.x onwards.
