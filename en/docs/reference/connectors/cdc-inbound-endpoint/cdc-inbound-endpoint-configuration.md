...
9. For MI version 4.2.0, download `mi-inbound-cdc-1.2.2.jar` from the [WSO2 Connector Store](https://store.wso2.com/connector/mi-inbound-cdc) and copy it to `<MI_HOME>/lib`:
    - `mi-inbound-cdc-1.2.2.jar`

!!!Note
    - The `mi-inbound-cdc-1.2.2.jar` is required for MI version 4.2.0 to resolve ClassNotFoundException for CDCPollingConsumer.
...
7. For MI version 4.2.0, download `mi-inbound-cdc-1.2.2.jar` from the [WSO2 Connector Store](https://store.wso2.com/connector/mi-inbound-cdc) and copy it to `<MI_HOME>/lib`:
    - `mi-inbound-cdc-1.2.2.jar`
