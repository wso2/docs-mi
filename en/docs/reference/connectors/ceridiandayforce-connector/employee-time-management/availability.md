...
<proxy xmlns="http://ws.apache.org/ns/synapse"
   ...
   <target>
      <inSequence>
         ...
         <property expression="${payload.filterAvailabilityStartDate}" name="filterAvailabilityStartDate"/>
         <property expression="${payload.filterAvailabilityEndDate}" name="filterAvailabilityEndDate"/>
