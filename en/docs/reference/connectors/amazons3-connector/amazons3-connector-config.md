...
The Access Key ID (e.g., your access key id) and Secret Access Key (e.g., your secret access key) will be required to configure the Amazon S3 connector.  You can manage S3 buckets by logging into the S3 console.
