...
The Access Key ID (e.g., <!-- access key id -->) and Secret Access Key (e.g., <!-- secret access key -->) will be required to configure the Amazon S3 connector.  You can manage S3 buckets logging into S3 console.
