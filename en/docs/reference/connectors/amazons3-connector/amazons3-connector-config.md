...
The Access Key ID and Secret Access Key will be required to configure the Amazon S3 connector.  You can manage S3 buckets by logging into the S3 console.
