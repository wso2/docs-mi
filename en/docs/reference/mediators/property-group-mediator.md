...
See [Property mediator]({{base_path}}/reference/mediators/property-mediator/#configuration) documentation for more information on how to configure a property.
