...
SOAP headers provide information about the message, such as the To and From values. You can use the `get-property()` function in the Property mediator to retrieve these headers. See [SOAP headers]({{base_path}}/reference/mediators/property-reference/soap-headers) documentation for more information.
