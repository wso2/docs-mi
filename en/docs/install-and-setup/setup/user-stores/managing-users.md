...
-	[Authentication]({{base_path}}/install-and-setup/setup/security/securing_management_api/#authentication-jwt) for internal APIs
...
-	[Authorization]({{base_path}}/install-and-setup/setup/security/securing_management_api/#authorization) for internal APIs
...
!!! Tip
	...
	Read more about about [authorization in the management API]({{base_path}}/install-and-setup/setup/security/securing_management_api/#authorization).
