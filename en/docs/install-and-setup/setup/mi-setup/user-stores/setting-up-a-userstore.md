...
Find out about [user credentials in the Micro Integrator]({{base_path}}/install-and-setup/setup/mi-setup/user_stores/managing-users/#users-credentials-in-the-mi).
...
3.	To connect the Micro Integrator to your RDBMS user store: 
	...
	2.	Add the relevant configurations for your RDBMS type.
		...
		See the complete list of [database connection parameters]({{base_path}}/reference/config-catalog-mi/#database-connection) and their descriptions. Also, see the recommendations for [tuning the JDBC connection pool]({{base_path}}/install-and-setup/setup/mi-setup/performance-tuning/jdbc-tuning).
...
For instructions on adding, deleting, or viewing users in the user store, see [Managing Users]({{base_path}}/install-and-setup/setup/mi-setup/user_stores/managing-users).
