...
For instructions on how to enable the required ciphers and to disable the weak ciphers in Micro Integrator, see [Configuring Transport-Level Security]({{base_path}}/install-and-setup/setup/transport-configurations/configuring-transports/#configuring-transport-level-security).
