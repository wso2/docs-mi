...
- [Install WSO2 Integrator: MI](https://wso2.com/devant/docs/develop/mi-for-vscode/install-wso2-mi-for-vscode/) extension on VS Code.

## Deployment steps

1. Create an MI Project and develop the integration. For this tutorial, the first step of [Build your first Integration](https://wso2.com/devant/docs/get-started/build-first-integration/first-integration-api-service/) is followed.
...
8. The **Build Details** will have the **Technology** already selected. Hence, you can click **Next** again to proceed.
...
1. In the Devant console, once the **Build Status** shows as `Build completed`, click **Test** on the development environment card. This will take you to the **Console** page.
