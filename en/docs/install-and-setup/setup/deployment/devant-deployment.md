...
3. Click on the **Deploy to WSO2 Cloud** button to deploy the integration on WSO2 Cloud.
4. If you are not logged in to WSO2 Cloud, you will be prompted to log in. Once you log in, if you have only one organization, it will be selected automatically. If not, the VS Code extension will prompt you to select an organization.
...
1. In the WSO2 cloud console, once the **Build Status** shows as `Build completed`, click **Test** on the development environment card. This will bring you to the **Console** page.
