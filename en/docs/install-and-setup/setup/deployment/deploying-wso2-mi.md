...
Create a simple Event Trigger using WSO2 MI for VS Code extension and deploy it in the two WSO2 Integrator: MI servers. See the instructions on [creating a Scheduled trigger]({{base_path}}/develop/creating-artifacts/creating-scheduled-task).
