...
1.  Go to the [WSO2 Micro Integrator releases page](https://github.com/wso2/micro-integrator/releases) and download the latest Micro Integrator distribution as a ZIP file.
