...
1.  Go to the [WSO2 Integrator: MI Downloads page](https://wso2.com/products/downloads/?product=wso2integrator&package=other-options&profile=mi) and download the latest WSO2 Integrator: MI distribution as a ZIP file.
...
-   **Set the properties from an external registry** : If you want to access properties from an external registry, you could create Java code that reads the properties at runtime from that registry. Be sure to store sensitive data such as username and password to connect to the registry in a property file instead of in the Java code and secure the properties file with the [secure vault]({{base_path}}/reference/mi-security-reference/customizing-secure-vault/).
